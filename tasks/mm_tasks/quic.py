...
from data.mm_data.quic_dataset import QuICDataset
...
@register_task("topic_description", dataclass=QuICConfig)
class QuICTask(OFATask):
    def __init__(self, cfg: QuICConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = QuICDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
